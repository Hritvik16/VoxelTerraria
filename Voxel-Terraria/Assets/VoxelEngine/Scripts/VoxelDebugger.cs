...
public class VoxelDebugger : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUIStyle titleStyle = new GUIStyle { alignment = TextAnchor.UpperLeft, fontSize = h * 3 / 100 };
        titleStyle.normal.textColor = Color.white;
        GUIStyle textStyle = new GUIStyle { alignment = TextAnchor.UpperLeft, fontSize = h * 2 / 100, richText = true };
